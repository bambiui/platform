---
title: Get Started
description: Install BambiUI in your project using the CLI.
---
...
Run the scoped CLI package from your project root. It exposes the `bambiui` executable, auto-detects your framework, creates `bambiui.config.json`, and writes the global design token file.
...
Options:
  ...
  --registry-url <url>                 Use a custom registry (default: https://bambi-ui.felekoglu.dev)
