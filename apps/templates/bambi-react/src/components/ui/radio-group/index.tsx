...
const SsrSelectedValueContext = React.createContext<string | undefined>(
  undefined,
);
...
export function RadioGroupItem({
  ...
  return (
    <div
      ...
      data-value={value}
      data-state={
        hasSelectedValue ? (isSelected ? "checked" : "unchecked") : undefined
      }
    >
      <input
...
export function RadioGroupIndicator({
  ...
  return (
    <span {...props} data-bambi-radio-group-indicator="">
      {children}
    </span>
  );
}
...
export function RadioGroupLabel({ children, ...props }: RadioGroupLabelProps) {
  return (
    <label {...props} data-bambi-radio-group-label="">
      {children}
    </label>
  );
}
