...
This docs app is suspended and is not an active workspace, build, registry, or CLI target. Do not use its old package, token, component, or legacy runtime-package examples as current bambiui architecture guidance.
